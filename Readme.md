...
* Студент: [Дмитрий Лудов](https://up.htmlacademy.ru/univer-html1/2/user/2226857).
* Наставник: `Политехнический университет`.
* Ссылка на профиль наставника: `https://htmlacademy.ru/profile/id2433073`.
---
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-univer-htmlcss-1/2226857-sedona-2) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
